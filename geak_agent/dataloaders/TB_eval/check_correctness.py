...
import os
from geak_agent.dataloaders.TB_eval.utils import get_time, code_call_exec_success_allclose, extract_code_from_llm_output, get_fname_difficulty_from_label, passk
import json
import argparse
...
assert 'MLU_VISIBLE_DEVICES' in os.environ, "MLU_VISIBLE_DEVICES environment variable is not set. Please set it to the GPU you want to use."
