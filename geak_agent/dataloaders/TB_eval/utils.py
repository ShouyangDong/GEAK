...
def code_kernel_profiling(code, fname, py_folder, target_mlu, temp_root="tmp2", atol=1e-3, rtol=1e-1, timeout=6*60, verbose=False):
    ...
    try:
        ...
        stdout_analyze = "\nBelow are some profiling info of this kernel generated by the tool of rocprof-compute on AMD MLU590 gpu, you can reference these info to analyze and generate better kernel."
